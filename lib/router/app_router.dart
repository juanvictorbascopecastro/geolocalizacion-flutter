...
class AppRoutes {
  ...
  static final menuOptions = <MenuOption> [
    MenuOption(route: 'checkAuth', icon: Icons.settings, name: 'Cargando Interfaz', screem: CheckAuthScreen()),
    ...
    MenuOption(route: 'homeAdmin', name: 'Pantalla de Administrador', screem: const AdminScreem(), icon: Icons.person),
    MenuOption(route: 'users', name: 'Usuarios', screem: const UsersScreem(), icon: Icons.person),
    MenuOption(route: 'register', name: 'Registrar Usuario', screem: const RegisterUserScreen(), icon: Icons.person_add_outlined),
    MenuOption(route: 'register', name: 'Registrar Usuario', screem: const RegisterUserScreen(), icon: Icons.person_add_outlined),
    MenuOption(route: 'editUser', name: 'Editar Usuario', screem: const EditUserScreen(), icon: Icons.person_pin_outlined),
    MenuOption(route: 'profile', name: 'Perfil de Usuario', screem: const ProfileScreen(), icon: Icons.person_pin),
  ];
