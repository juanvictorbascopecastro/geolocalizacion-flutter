          ...
          title: Row(
            children: <Widget>[
              SizedBox(
                ...
                child: persona.foto == null
                  ? CircleAvatar(
                      ...
                      child: Text(persona.nombre[0], style: const TextStyle(fontSize: 28),),
                  ) : ClipOval(
                  child: FadeInImage.assetNetwork(
                      placeholder: 'assets/loading.gif',
                      placeholderCacheWidth: 60,
                      placeholderCacheHeight: 60,
                      image: personaService.getUrlImage(persona.foto!, 'persona'),
              ...
              Column(
                ...
                children: <Widget>[
                  Text('${persona.nombre} ${persona.apellido}', style: const TextStyle(fontSize: 17, fontWeight: FontWeight.bold,),),
                  Text(persona.email, style: const TextStyle(fontSize: 15, color: Colors.grey)),
                ],
              )
            ],
          ),
