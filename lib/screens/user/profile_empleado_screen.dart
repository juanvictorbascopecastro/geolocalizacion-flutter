...
class ProfileEmpleadoScreen extends StatelessWidget {
  const ProfileEmpleadoScreen({super.key});
      ...
      child: Form(
        ...
        child: Column(
          children: [
            ...
            TextFormField(
              initialValue: authForm.auth.nombre,
            ...
            TextFormField(
              initialValue: authForm.auth.apellido,
              autovalidateMode: AutovalidateMode.onUserInteraction,
            ...
            IntlPhoneField(
              initialValue: authForm.auth.telefono,
              autovalidateMode: AutovalidateMode.onUserInteraction,
            ...
            TextFormField(
              initialValue: authForm.auth.direccion,
              autovalidateMode: AutovalidateMode.onUserInteraction,
              keyboardType: TextInputType.streetAddress,
              decoration: InputDecorations.authInputDecoration(
            ...
            TextFormField(
              initialValue: authForm.auth.email,
              autovalidateMode: AutovalidateMode.onUserInteraction,
